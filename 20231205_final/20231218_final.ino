...
void loop() {
  ...
  if(millis() - timeNumber >= 20000) {
    ...
    String url1 = url + "&field1=" + tempArr[resultID] + "&field2=" + humdArr[resultID];
  ...
  if (isFlame <= 4000 && temperature >= 25) { //有火災
    SerialBT.println("Flane");
    Serial.println("有火災");
  ...
  else if (isFlame <= 4000 && temperature < 25) {  //有人在玩火
